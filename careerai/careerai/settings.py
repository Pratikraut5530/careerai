...
SECRET_KEY = 'django-insecure-xs8@3dw@$lq2*k&9y(oz%t2k48y^35ghb611^=id=4&hc@i+9h'
...
MONGO_DB_NAME = os.getenv("MONGO_DB_NAME", "careerai-db")
...
# Dummy database for Django's built-in auth
DATABASES = {
    'default': {
